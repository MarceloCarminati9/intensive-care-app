...
// ... outros endpoints que já tínhamos ...
...
// para qualquer endereço que não seja de API. O JavaScript do seu site
// cuidará de mostrar a página correta (dashboard, unit-view, etc.).
app.get('*', (req, res) => {
